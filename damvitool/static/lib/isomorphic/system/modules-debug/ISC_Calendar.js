...
/*
  ...
  Version v10.0p_2014-11-21/LGPL Deployment (2014-11-21)
...
if (window.isc && isc.version != "v10.0p_2014-11-21/LGPL Deployment") {
    isc.logWarn("SmartClient module version mismatch detected: This application is loading the core module from "
        + "SmartClient version '" + isc.version + "' and additional modules from 'v10.0p_2014-11-21/LGPL Deployment'. Mixing resources from different "
...
isc.CalendarView.addProperties({
    ...
    mouseMove : function () {
        var cal = this.calendar,
            ...
            rowNum = this.lastMouseOverRow,
            colNum = this.lastMouseOverColumn,
